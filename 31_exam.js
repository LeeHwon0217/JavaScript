...
a1.deposit(1000);
console.log(a1.balance); // 1000
a1.balance = 5000; // 직접 잔액 설정 불가
console.log(a1.balance); // 1000
a1.withdraw(300); // 300원 출금되었습니다.
console.log(a1.balance); // 700

const a2 = new Account("반하나");
a2.deposit(2000);
console.log(a2.balance); // 2000
a2.withdraw(2500); // 잔액이 부족합니다.

console.log(Account.getAccountCount()); // 총 계좌 수: 2
